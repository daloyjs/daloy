...
This workshop tracks the current published release train: `create-daloy@1.0.0-rc.1` scaffolds templates with `@daloyjs/core@^1.0.0-rc.1`, and this workshop uses that same npm range so the exercises match the latest generated projects.
