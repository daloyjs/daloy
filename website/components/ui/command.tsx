...
function CommandList({
  ...
  return (
    <CommandPrimitive.List
      ...
      className={cn(
        "max-h-72 scroll-pbs-1 scroll-pbe-1 overflow-x-hidden overflow-y-auto scrollbar-gutter-stable scrollbar-thin scrollbar-thumb-border/70 scrollbar-track-transparent outline-none",
        className
      )}
      {...props}
    />
