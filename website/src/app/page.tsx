...
import { ArrowRight, Boxes, FileJson2, Lock, Rocket, Shield, Zap } from "lucide-react";
      ...
      <section>
        <div className="mx-auto max-w-3xl px-6 py-20 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Button asChild size="lg">
              <Link href="/docs/installation">Install DaloyJS</Link>
            </Button>
            <Button asChild size="lg" variant="outline">
              <Link href="/docs/tutorials/bookstore">Build a bookstore API</Link>
            </Button>
          </div>
        </div>
      </section>
