...
/**
 * Post-specific OpenGraph / Twitter card for the IBM Cost of a Data Breach
 * 2026 write-up. Matches the site's dark brand card and leads with three
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex" }}>
          602 orgs · Ponemon / IBM · 21st year
        </div>
      </div>
    </div>,
    size
