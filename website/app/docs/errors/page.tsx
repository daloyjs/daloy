...
export default function Page() {
  return (
    <>
      ...
      <p>
        DaloyJS errors are first-class. Every thrown <code>HttpError</code>{" "}
        serializes to{" "}
        <a
        ...
        with a stable <code>type</code> URI, a request-id, and the appropriate
        Content-Type.
      </p>
  ...
  InternalError,                     // 500 (detail redacted in production)
      ...
      <CodeBlock
        code={`import { NotFoundError } from "@daloyjs/core";
...
app.get(
  ...
  async ({ params }) => {
    ...
    return { status: 200, body: user };
      ...
      <p>
        The request id is returned to the client in two places: the{" "}
        <code>x-request-id</code> response header, and (per{" "}
        <a
          href="https://www.rfc-editor.org/rfc/rfc9457#name-members-of-a-problem-detail"
          target="_blank"
          rel="noreferrer"
        >
...

{
  ...
  "instance": "urn:request:c9aa8e1c-7a6e-4f1e-9f44-c2e5d2c4a431"
      ...
      <p>
        ...
        {", "}DaloyJS strips the <code>detail</code> field on any 5xx response
        so internal stack traces and SQL fragments don&apos;t leak to clients.
        The full error is still emitted to your logger via the{" "}
        <code>onError</code> hook.
      </p>
...
export class QuotaExceededError extends HttpError {
  constructor(resource: string) {
    super(429, {
      ...
      <h2 id="custom-onerror">
        Custom <code>onError</code>
      </h2>
      <CodeBlock
        code={`app.use({
