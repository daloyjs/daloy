...
export default function Page() {
  return (
    <>
      ...
      <p>
        This is the right home for the big public demo API: a dedicated
        tutorial-style landing page in the docs, with the actual interactive
        explorer hosted separately. That keeps the DaloyJS docs focused while
        still giving users a realistic large-spec environment to test against.
      </p>
      ...
      <p>
        ...
        <a
          href="https://fakerestapi.vercel.app/index.html"
          target="_blank"
          rel="noreferrer"
        >
      ...
      <ul>
        ...
        <li>
          A catalog with roughly 600 endpoints is too large for the core docs
          sidebar structure.
        </li>
        <li>
          Users looking at OpenAPI, client generation, and docs rendering need a
          realistic large example.
        </li>
      </ul>
      ...
      <ul>
        <li>
          Pressure-test docs UIs and endpoint navigation with a non-trivial API
          size.
        </li>
        <li>
          Verify OpenAPI generation and downstream codegen workflows on a large
          contract.
        </li>
        <li>
      ...
      <p>
        Keep this page in the docs as the entry point, and host the actual
        explorer as a separate live surface such as{" "}
        <code>demo.daloyjs.dev</code> or <code>api-demo.daloyjs.dev</code>
        {". "}The docs page should explain the purpose of the demo, link to the
        live explorer, and link back into the relevant DaloyJS guides.
      </p>
