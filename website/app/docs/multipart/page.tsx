  ...
  return (
    <>
      ...
      <p>
        ...
        {", "}let you describe an upload contract once, get runtime validation
        (size caps, MIME allowlists, filename matchers), an end-to-end-typed
        handler, and a correct OpenAPI document with{" "}
        <code>multipart/form-data</code> media type and{" "}
    ...
    return { status: 201 as const, body: { ok: true } };
      ...
      <ul>
        ...
        <li>
          ...
          {": "}predicate for filename validation, useful for forcing
          extensions.
        </li>
        <li>
        ...
        <li>
          <code>optional</code>
          {": "}when <code>true</code>
          {", "}accept <code>undefined</code>/<code>null</code> values without
          raising.
        </li>
        <li>
          <code>format</code>
          {": "}OpenAPI hint, defaults to <code>&quot;binary&quot;</code>.
        </li>
      </ul>
  ...
  multipart: {
    ...
    maxFiles:     4,         // total file uploads
      ...
      <p>
        ...
        {", "}the OpenAPI generator emits <code>multipart/form-data</code> as
