...
export function buildApp() {
  ...
  return app;
      ...
      <ul>
        <li>
          <code>--json</code>
          {": "}emit a machine-readable JSON document instead of a human table.
        </li>
        <li>
          <code>--check</code>
        ...
        <li>
          <code>--schemas</code>
          {": "}add a <code>B/Q/P/H</code> column showing which of body, query,
        ...
        <li>
          <code>--asyncapi</code>
          {": "}print the AsyncAPI 3.0 document for <code>app.ws()</code>{" "}
          WebSocket surfaces.
        </li>
        <li>
          <code>--ai</code>
        ...
        <li>
          ...
          route metadata into an LLM system prompt where every token counts.
        </li>
        <li>
          <code>--tag &lt;tag&gt;</code>
          {": "}only show routes that declare this tag.
        </li>
        <li>
          <code>--method &lt;method&gt;</code>
          {": "}only show routes for this HTTP method.
        </li>
        <li>
          <code>--runtime &lt;node|bun|deno&gt;</code>
          {": "}force the runtime for <code>daloy dev</code>.
        </li>
        <li>
          <code>--audit-secrets</code>
          {": "}make <code>daloy doctor</code> scan matching environment
          variables for known-weak placeholders and short production secrets.
        </li>
        <li>
          <code>--no-audit-defaults</code>
          {": "}skip the default secure-defaults audit in{" "}
...
pnpm exec daloy dev ./src/server.ts`}
      ...
      <p>
        ...
        <code>inspect</code>
        {", "}then audits the live configuration for secure-by-default
        regressions. It exits 1 when it finds an error-level issue, so it can
        guard CI or a container <code>HEALTHCHECK</code>
        {": "}
      </p>
      <CodeBlock
        language="bash"
