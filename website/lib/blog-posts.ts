/**
 * Canonical list of published blog posts, newest first.
 *
 * Shared by the blog index ([app/blog/page.tsx](../app/blog/page.tsx)) and the
 * `llms.txt` index ([app/llms.txt/route.ts](../app/llms.txt/route.ts)) so both
 * surfaces stay in sync. When adding a post, add it here (plus a
 * `STATIC_PATHS` entry in [app/sitemap.ts](../app/sitemap.ts)).
 */
...
/** A single published blog post as listed in {@link BLOG_POSTS}. */
